...
function invertAll {
	...
	echo -ne $g0"\t"$g1"\t" > results/mauve/20180221-Bp/05.colinear-invertAll-gap1500-20180425/$out;

	./src/mauve.invert-symmetric.pl -in $bb -t $g1ter -size -seq1 $g1len >> results/mauve/20180221-Bp/05.colinear-invertAll-gap1500-20180425/$out;
