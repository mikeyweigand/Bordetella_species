...
# bed2 = generateRandomBed(nr = 100, nc = 4)
# head(bed2)
# head(bed)
# circos.par("track.height" = 0.08, start.degree = 90,
#            canvas.xlim = c(-1, 1), canvas.ylim = c(-1, 1), gap.degree = 2,
...
# circos.genomicTrack(bed2, stack = TRUE, 
...
BP.obs <- read.table("/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/20180614-Bp-check-gap1500-cat.NR.invertALL.txt",
                     sep="\t",header=F)
...
J549.pred <- read.table("/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/invert-predict/J549-ISall-inverts-20180719.txt",
                        sep="\t",header=F,
...
J549.bls <- read.table("/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/invert-predict/J549-ISall-20180719.bed",
                        sep="\t",header=F,
...
J549.ptxp1 <- read.table("/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/J549-breakpoints/J549-breakpoints.ptxp12.sorted.uniq.merged1000.txt",
                         sep="\t",header=F,
...
J549.ptxp3 <- read.table("/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/J549-breakpoints/J549-breakpoints.ptxp3.sorted.uniq.merged1000.txt",
                         sep="\t",header=F,
                         colClasses = c("numeric"))
J549.bks3 = data.frame("Bp_J549",J549.ptxp3$V1, J549.ptxp3$V1+1,1)
colnames(J549.bks3) = c("chr","start","end","value1")

J549.bkpts1k <- read.table("/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/J549-breakpoints/J549-breakpoints.sorted.uniq.merged1000.txt",
                            sep="\t",header=F,
                            colClasses = c("numeric"))
...
#draw that plot!
pdf(file = "/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/J549-breakpoints/J549-circlize-20180823.pdf",
...
C690.bls <- read.table("/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/invert-predict/C690-ISall-20180719.bed",
                       sep="\t",header=F,
                       colClasses = c("character", "numeric","numeric"))
...
C690.pred <- read.table("/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/invert-predict/C690-ISall-inverts-20180719.txt",
                        sep="\t",header=F,
                        colClasses = c("character", "numeric","numeric","numeric","numeric","numeric","numeric","numeric","numeric","numeric","numeric"))
...
pdf(file = "/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/J549-breakpoints/C690-circlize-20180823.pdf",
...
B271.bls <- read.table("/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/invert-predict/B271-ISall-20180719.bed",
                       sep="\t",header=F,
                       colClasses = c("character", "numeric","numeric"))
...
B271.pred <- read.table("/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/invert-predict/B271-ISall-inverts-20180719.txt",
                        sep="\t",header=F,
                        colClasses = c("character", "numeric","numeric","numeric","numeric","numeric","numeric","numeric","numeric","numeric","numeric"))
...
pdf(file = "/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/J549-breakpoints/B271-circlize-20180823.pdf",
    width = 3, height = 3, useDingbats = F)
circos.par("track.height"=0.08, start.degree=90, gap.degree=0)
