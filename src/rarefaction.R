...
(ggplot()
  ...
  #+ geom_line(data = data.frame(t(rc)),aes(x=N,y=(C + SE*2)),size=0.5,linetype="dashed")
  #+ geom_line(data = data.frame(t(rc)),aes(x=N,y=(C - SE*2)),size=0.5,linetype="dashed")
...
#ggsave("/home/yrh8/Documents/Bordetella_species/results/mauve/20180221-Bp/04.colinear-mcl/rarefaction/20180425-Bp-check-gap1500-mcl-rarefaction-years2k10.pdf", device = 'pdf', width = 6, height = 4, units = 'in', useDingbats=F)
